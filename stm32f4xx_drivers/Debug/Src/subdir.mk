...
C_SRCS += \
../Src/005_spi_cmd_handling.c \
../Src/syscalls.c \
../Src/sysmem.c 

OBJS += \
./Src/005_spi_cmd_handling.o \
./Src/syscalls.o \
./Src/sysmem.o 

C_DEPS += \
./Src/005_spi_cmd_handling.d \
./Src/syscalls.d \
./Src/sysmem.d 
...
Src/005_spi_cmd_handling.o: ../Src/005_spi_cmd_handling.c
	arm-none-eabi-gcc "$<" -mcpu=cortex-m4 -std=gnu11 -g3 -DSTM32 -DSTM32F4 -DSTM32F446RETx -DDEBUG -DNUCLEO_F446RE -c -I../Inc -I"E:/STM32CUBEIDE/MCU1/stm32f4xx_drivers/drivers/Inc" -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -MMD -MP -MF"Src/005_spi_cmd_handling.d" -MT"$@" --specs=nano.specs -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -o "$@"
